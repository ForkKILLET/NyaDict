...
<template>
     <div class="card content">
        ...
        by <a href="https://github.com/ForkKILLET" target="_blank">ForkKILLET</a> with <span class="love">&lt;3</span>
        
        <div class="last-commit barber">
            <a :href="`https://github.com/${repoName}/commit/${lastCommitHash}`" target="_blank">
